...
class GoogleSTTConfig(BaseModel):
    ...
    # The google-cloud-speech SDK serialises AudioEncoding as an int (e.g. 1=LINEAR16);
    # the REST API also accepts the string name. Accept either; the OVOS plugin
    # ignores this anyway and works off the raw bytes.
